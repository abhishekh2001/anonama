...
type ChooseClaimProp = {
    handleCategoryClick: (provider: string, text: string) => void
}

const ChooseClaim: React.FC<ChooseClaimProp> = ({ handleCategoryClick }) => {
    const catMap = sidebarManagerGroupMap(handleCategoryClick)
    console.log(catMap)
    return (
        <div className="my-3">
            {/* {catMap.map((cat) => {
                return <p>{cat.groupIconSVG}</p>
            })} */}
            {/* <DrowdownComponent /> */}
                        ...
                        <div className="py-1">
                            {catMap.map((cat) => {
                                return cat.subcats?.map((subcat) => {
                                    return (
                                        <Menu.Item key={subcat.providerName}>
                                            {({ active }) => (
                                                <a
                                                    href="#"
